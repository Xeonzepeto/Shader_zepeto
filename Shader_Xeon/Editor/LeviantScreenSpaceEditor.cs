...
public class XeonScreenSpaceEditor : ShaderGUI
{
    ...
    public void defineStyles()
    {
        ...
        bannerTex = Resources.Load<Texture2D>("XeonHeaderNew");
    ...
    void DrawStatic()
    {
        ...
        GUILayout.Label(
            "-Static Added by:xeon\n" +
            "-Updated by: xeonzepeto", EditorStyles.miniBoldLabel);
    }
    void DrawVignette()
    {
    ...
    void DrawHELP()
    {
        ...
        GUILayout.Label(
            "-If you have any questions DM us: xeon\n" +
    ...
    void DrawCredits()
    {
        ...
        GUILayout.Label(
            "-Made By: xeonzepeto\n" +
            "-Edited by: xeon\n" +
            "-Editor Created by: xeon", EditorStyles.helpBox);
        EditorGUI.indentLevel--;
    }
    //Draws Buttons
